            ...
            <section className="">
                ...
                <div className="bg-darkEletricBlue text-white p-16 text-center">
                    <div className="w-10/12 mx-auto">
                        <h2 className="text-center font-alkalami text-4xl tracking-wide text-sunray">Why Choose Tinsley Moving Services?</h2>
                    ...
                    <div className="font-poppins p-7 mx-auto mt-6 w-9/12 lg:w-11/12 lg:grid lg:grid-cols-3 lg:gap-6 lg:items-start">
                        <div className="">
                            <FontAwesomeIcon className="text-4xl text-sunray" icon={faPeopleCarryBox} />
                        ...
                        <div className="mt-4 lg:mt-0">
                            <FontAwesomeIcon className="text-4xl text-sunray" icon={faRoute} />
                        ...
                        <div className="mt-4 lg:mt-0">
                            <FontAwesomeIcon className="text-4xl text-sunray" icon={faHouseChimney} />
